...
const createHostEnvHelpPrompt = "Following environment variables are required for " +
	constants.CreateHostCommand + " setup:"

var createHostEnvHelp = map[string]string{
...
func (task *CreateHost) PrintHelp(w io.Writer) {
	setup.PrintEnvHelp(w, createHostEnvHelpPrompt, "", createHostEnvHelp)
	fmt.Fprintln(w, "")
}
