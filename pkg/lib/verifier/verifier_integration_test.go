...
//
// Run unit tests: go test github.com/intel-secl/intel-secl/v5/pkg/lib/verifier
//
// coverage report...
// go test github.com/intel-secl/intel-secl/v5/pkg/lib/verifier -v -coverpkg=github.com/intel-secl/intel-secl/v5/pkg/lib/verifier -coverprofile cover.out
