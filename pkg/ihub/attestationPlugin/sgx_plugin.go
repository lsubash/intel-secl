...
var SGXClient = &sgxhvsclient.Client{}
...
func GetHostPlatformDataSGX(hostName string, config *config.Configuration, certDirectory string) ([]byte, error) {
...
func initializeSKCClient(con *config.Configuration, certDirectory string) (*sgxhvsclient.Client, error) {
