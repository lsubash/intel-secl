...
func SetCertifyAiksRoutes(router *mux.Router, store *postgres.DataStore, certStore *models.CertificatesStore, aikCertValidity int, enableEkCertRevokeChecks bool, requireEKCertForHostProvision bool) *mux.Router {
